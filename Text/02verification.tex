...
Vždy sa snažíme nájsť správne pozorovanie predpoveď a nie naopak.
...
Binárne predpovede alebo inak áno/nie predpovede nám hovoria, či sa daná udalosť udiala alebo nie. Slúžia teda ako upozornenie na javy ako hmla, búrka, blesky, silný vietor a podobne. Na ich verifikáciu slúžia $ 2\times2 $ kontingenčné tabuľky, z ktorých možno počítať rôzne štatistiky. Mnoho-kategorické predpovede nám rozdeľujú udalosti do viacerých kategórií (zvyčajne 3-4), napríklad v prípade dažďa na: \textit{dážď}/\textit{sneženie}/\textit{mrznúci dážď}. 
...
V našej práci riešime verifikáciu spojitých premenných, ktorá zvyčajne poskytuje štatistiky určujúce ako veľmi sa daná predpoveď líši od pozorovania. Tieto štatistiky opisujeme v ďalšej sekcii tejto kapitoly.
