...
V tejto sekcii sa snažíme stručne zhrnúť základné požiadavky užívateľov na vizualizáciu vyššie spomenutých dát. Medzi základné požiadavky

%TODO, co bude tuto, tak to ja neviem moc
- \textit{focus+context} \\
- vyuzitie tohto, co meteorologovia uz poznaju \\

Konkrétnejšie požiadavky na vizualizáciu sa najlepšie špecifikujú pomocou úloh, ktoré budú užívatelia vykonávať.
\subsection{Užívateľské úlohy}
V tejto časti pomocou taxonómie úloh vizualizácie navrhnutej súrodencami Andirenko \cite{keylist}, zhrnieme základné uvažované úlohy, ktoré budú užívatelia vykonávať. Jednotlivé úlohy sa definujú pomocou ukážkových otázok, ktoré sa budú klásť na vizualizáciu.
...
\begin{itemize}[noitemsep]
	...
	\begin{itemize}
		...
		\item Aká jed distribúcia chýb pre túto hodinu?	 
	\end{itemize}
...
\begin{itemize}[noitemsep]
	...
	\begin{itemize}
			\item Kedy sú predpovede najpresnejšie?
			\item Kedy sú predpovede najslabšie?
	\end{itemize}
