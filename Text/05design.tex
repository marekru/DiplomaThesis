...
Autor v knihe ďalej spomína opisné charakteristiky pre časovo orientované dáta, ktoré sú tieto štyri: \textit{škála}, \textit{referenčný rámec}, \textit{druh dát}, \textit{počet premenných}. V stručnosti to zhrnieme tak, že naše dáta sú kvantitatívneho charakteru, abstraktné, určujúce stavy a nie udalosti s mnohými premennými.

\section{Špecifikácia požiadaviek na vizualizáciu}
V tejto sekcii sa snažíme stručne zhrnúť základné požiadavky užívateľov na vizualizáciu vyššie spomenutých dát.

%TODO, co bude tuto, tak to ja neviem moc
- \textit{focus+context} \\
- vyuzitie tohto, co meteorologovia uz poznaju \\
- hladanie, porovnanie, vztahy \\
- pattern definition, search, comparison. \\
- tasky su zadane ako mnozina otazok \\
