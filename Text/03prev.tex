...
Krabicový diagram umožňuje mnoho ďalších rozšírení napríklad pridaním informácie o hustote dát (histogramový krabicový diagram, vázový diagram, huslový diagram [...]), rozšírením pre viacrozmerné dáta (vrecový graf, 2D krabicový diagram [...] ) alebo zobrazením hodnôt v inej súradnicovej sústave (napríklad polárnej - vejárový graf [...]). Opis týchto techník je však nad rámec tejto práce, preto ho tu ani nebudeme uvádzať.
