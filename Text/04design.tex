...
Jeden \textit{pruh} v grafe definujeme pomocou dvojíc hodnôt - spodným a jeho protiľahlým kvantilom.

Jeden \textit{pruh} v grafe je definovaný dvoma alebo jednou množinou kvantilov. Prvá množina je spodný kvantil a druhá množina je k nej protiľahlý kvantil. Spodnými kvantilmi sú kvantily menej ako $ Q_{0.5} $. Teda ak máme spodný kvantil $ Q_{0.25} $, tak k nemu protiľahlý kvantil je $ Q_{0.75} $ a jediný pruh definovaný jednou množinou je medián, teda kvantil $ Q_{0.5} $. 

Takto definovaný pruh vizualizujeme ako plochu medzi dvoma ohraničujucími množinami kvantilov, ktoré tento pruh definujú.
